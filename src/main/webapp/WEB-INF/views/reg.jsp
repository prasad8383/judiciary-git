...
<body>
<form id='reg' action='/loan_application/adduser' method="post" >
	<table align='center' cellspacing='5' width='50%' style='margin-top:7%'>
		<tr><td colspan="3" align='center'><b><font color='red' size="5">Personal Details</font></b></td></tr>
		<tr>
			<td align='center'>First Name</td><td><input type='text' id='txtfname' name = "fname"><center><span id='errmsg1'></center></span></td>
		</tr>
        <tr>
		...
		<tr>
			<td align='center'>Password</td><td><input type='text' id='txtpass' name = "userPassword"><center><span id='errmsg4'></center></td></span>
		</tr>
		<tr>
			<td align='center'>Confirm Password</td><td><input type='text' id='txtconpass'><center><span id='errmsg5'></center></span></td>
		</tr>
		<tr>
			<td colspan='2' align='right'><input type="submit" id='register' class='btn' value="Register">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value='Clear' class='btn'><td></td></td>
		</tr>
	</table>
</form>
</body>
